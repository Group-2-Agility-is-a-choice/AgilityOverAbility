  ...
  if(localStorage.length!=0) {
    ...
    try {
      ...
      //});
        ...
        let unit = obj[key][2];
        let item = obj[key][0];
        let list = "<div class='form-check m-3' onclick='checkedBox(this)'><input class='form-check-input' type='checkbox' id='"+item+"Box'><label class='form-check-label' for='"+item+"Box'>"
        let form = list+"<input type='number' id='"+item+"Input' min='0' style='width:75px;' value='"+amount+"' placeholder='"+amount+"'>";
...
function update() {
  ...
  try {
      ...
      //});
        ...
        if (newAmount!=0) {
          let list = "<div class='form-check m-3' onclick='checkedBox(this)'><input class='form-check-input' type='checkbox' id='"+item+"Box'><label class='form-check-label' for='"+item+"Box'>"
          let form = list+"<input type='number' id='"+item+"Input' style='width:75px;' min='0' value='"+newAmount+"' placeholder='"+newAmount+"'>";
